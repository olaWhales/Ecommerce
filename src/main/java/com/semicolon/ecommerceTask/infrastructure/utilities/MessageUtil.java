...
public class MessageUtil {
    ...
    public static final String FAILED_TO_RETRIEVE_USER_DETAILS ="Failed to retrieve user details for token. Error: {}";
    public static final String ACCESS_TOKEN = "access_token";
    public static final String PREFERRED_USERNAME = "preferred_username";
    public static final String EMAIL = "email";
    public static final String FAILED_TO_ASSIGN_ROLE_IN_KEYCLOAK = "Failed to assign role in Keycloak: ";
    public static final String REALM_ACCESS = "realm_access";
    public static final String FAILED_TO_CREATE_USER_IN_KEYCLOAK = "Failed to create user in Keycloak";
    public static final String AN_ERROR_OCCURRED_WHILE_CREATING_USER_IN_KEYCLOAK = "An error occurred while creating user in Keycloak: {}";
    public static final String USER = "USER";
    public static final String REALMS = "/realms/";
    public static final String PROTOCOL_OPENID_CONNECT_USER_INFO = "/protocol/openid-connect/userinfo";
    ...
    public static final String ONLY_IMAGE_FILES_ARE_ALLOWED = "Only image files are allowed";
    ...
    public static final String USER_DATA_CANNOT_BE_NULL = "User data cannot be null";
    public static final String NOT_ENOUGH_STOCK_AVAILABLE_FOR_PRODUCT_WITH_ID = "Not enough stock available for product with ID: ";
    public static final String USER_ALREADY_EXIST_IN_KEYCLOAK = "User already exit in keycloak";
    public static final String CUSTOMER_NOT_FOUND = "Customer not found ";
    public static final String FAILED_TO_EMPTY_FILE = "Failed to store empty file";
    public static final String A_SELLER_REGISTRATION_REQUEST_IS_ALREADY_PENDING = "A seller registration request is already pending for %s";
    public static final String SELLER_REGISTRATION_REQUEST_SUBMITTED_SUCCESSFULLY = "Seller registration request submitted successfully for %s. It is now pending admin approval.";
    ...
    public static final String PRODUCT_ASSOCIATED_WITH_CART_ITEM_NOT_FOUND = "Product associated with cart item does not exist";
